...
<div class="tipoparametro-index">
    <div class="card">
        <div class="card-header card-header-warning">
            ...
            <p class="card-category">Registro Nomenclador de Parámetros </p>
        </div>
    ...
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
                ...
                <p>
                    <?= Html::button('Registrar Nomenclador de Parámetros', [
                        'value'=>Url::to('index.php?r=tipoparametro/create'),
                ...
                Modal::begin(
                    [
                        'title'=>'<h4>Nomenclador de Parámetros</h4>',
