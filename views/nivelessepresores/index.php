...
/* @var $searchModel app\models\NivelessepresoresSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = 'Nivel de Supresor';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="nivelessepresores-index">
    <div class="card">
        <div class="card-header card-header-warning">
            <h4 class="card-title"><?=$this->title?></h4>
            <p class="card-category">Registro de Parámetro de Clasificación: Nivel de Supresor</p>
        </div>
    ...
    <p>
        <?= Html::button('Registrar Nivel de Supresor', [
            'value'=>Url::to('index.php?r=nivelessepresores/create'),
