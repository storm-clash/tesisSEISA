...
/* @var $model app\models\Cantsistemas */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="cantsistemas-form">
    <div class="card">
    ...
    <?= $form->field($model, 'nombre')->textInput(['class'=>'form-control class-content-title_series','disabled'=>true,'value'=>'Cantidad de Sistemas']) ?>
