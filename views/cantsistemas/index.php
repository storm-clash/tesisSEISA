...
/* @var $searchModel app\models\CantsistemasSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = 'Cantidad de Sistemas';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="cantsistemas-index">
    <div class="card">
        <div class="card-header card-header-warning">
            <h4 class="card-title"><?=$this->title?></h4>
            <p class="card-category">Registro de Parámetro de Clasificación: Cantidad de Sistemas</p>
        </div>
    ...
    <p>
        <?= Html::button('Crear Cantidad de Sistemas', [
            'value'=>Url::to('index.php?r=cantsistemas/create'),
