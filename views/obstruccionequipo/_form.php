...
<div class="obstruccionequipo-form">
    <div class="card">
    ...
    <?= $form->field($model, 'nombre')->textInput(['class'=>'form-control class-content-title_series','disabled'=>true,'value'=>'Obstrucción del Equipamiento'])?>
