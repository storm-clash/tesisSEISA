...
/* @var $searchModel app\models\ObstruccionequipoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = 'Obstrucción del Equipo';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="obstruccionequipo-index">
    <div class="card">
        <div class="card-header card-header-warning">
            <h4 class="card-title"><?=$this->title?></h4>
            <p class="card-category">Registro de Parámetro de Clasificación: Obstrucción del Equipo</p>
        </div>
    ...
    <p>
        <?= Html::button('Registrar Obstrucción del Equipo', [
            'value'=>Url::to('index.php?r=obstruccionequipo/create'),
    ...
    Modal::begin(
        [
            'title'=>'<h4>Obstrucción del Equipo</h4>',
            'id'=>'your-modal',
            'size'=>'modal-md',
