...
/* @var $searchModel app\models\PararrayosSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = 'Pararrayos';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pararrayos-index">
    <div class="card">
        <div class="card-header card-header-warning">
            <h4 class="card-title"><?=$this->title?></h4>
            <p class="card-category">Registro de Parámetro de Clasificación: Pararrayos</p>
        </div>
    ...
    <p>
        <?= Html::button('Registrar Pararrayos', [
            'value'=>Url::to('index.php?r=pararrayos/create'),
