...
/* @var $model app\models\Pararrayos */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="pararrayos-form">
    <div class="card">
    ...
    <?= $form->field($model, 'nombre')->textInput(['class'=>'form-control class-content-title_series','disabled'=>true,'value'=>'Cantidad de Pararrayos']) ?>
