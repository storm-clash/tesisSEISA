...
/* @var $searchModel app\models\CondambsegelectSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = 'Condiciones Ambientales';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="condambsegelect-index">
    <div class="card">
        <div class="card-header card-header-warning">
            <h4 class="card-title"><?=$this->title?></h4>
            <p class="card-category">Registro de Parámetro de Clasificación: Condiciones Ambientales para equipos electrónicos</p>
        </div>
    ...
    <p>
        <?= Html::button('Registrar Condiciones Ambientales', [
            'value'=>Url::to('index.php?r=condambsegelect/create'),
