...
/* @var $searchModel app\models\CompequiposelecSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = 'Complejidad Equipo Eléctrico';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="compequiposelec-index">
    <div class="card">
    ...
    <p>
        <?= Html::button('Registrar Complejidad', [
            'value'=>Url::to('index.php?r=compequiposelec/create'),
    ...
    Modal::begin(
        [
            'title'=>'<h4>Complejidad Equipos Electrónicos</h4>',
            'id'=>'your-modal',
            'size'=>'modal-md',
