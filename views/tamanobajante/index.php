...
/* @var $searchModel app\models\TamanobajanteSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = 'Tamaño del Bajante';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tamanobajante-index">
    <div class="card">
        <div class="card-header card-header-warning">
            <h4 class="card-title"><?=$this->title?></h4>
            <p class="card-category">Registro de Parámetro de Clasificación: Tamaño del Bajante</p>
        </div>
    ...
    <p>
        <?= Html::button('Registrar Tamaño del Bajante', [
            'value'=>Url::to('index.php?r=tamanobajante/create'),
    ...
    Modal::begin(
        [
            'title'=>'<h4>Tamaño del Bajante</h4>',
            'id'=>'your-modal',
            'size'=>'modal-md',
