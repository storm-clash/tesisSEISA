...
<div class="complejidadsistfijos-form">
    <div class="card">
    ...
    <?= $form->field($model, 'nombre')->textInput(['class'=>'form-control class-content-title_series','disabled'=>true,'value'=>'Complejidad del Equipamiento'])?>
