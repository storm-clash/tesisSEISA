...
/* @var $searchModel app\models\ComplejidadsistfijosSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = 'Complejidad del Equipamiento';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="complejidadsistfijos-index">
    <div class="card">
        <div class="card-header card-header-warning">
            <h4 class="card-title"><?=$this->title?></h4>
            <p class="card-category">Registro de Parámetro de Clasificación: Complejidad Equipamiento para Sistemas Fijos</p>
        </div>
    ...
    <p>
        <?= Html::button('Registrar Complejidad', [
            'value'=>Url::to('index.php?r=complejidadsistfijos/create'),
    ...
    Modal::begin(
        [
            'title'=>'<h4>Complejidad del Equipamiento</h4>',
            'id'=>'your-modal',
            'size'=>'modal-md',
