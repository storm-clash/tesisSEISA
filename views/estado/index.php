...
<div class="estado-index">
    <div class="card">
        <div class="card-header card-header-warning">
            ...
            <p class="card-category">Registro de Estado Técnico de los equipos</p>
        </div>
    ...
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
                ...
                <p>
                    <?= Html::button('Registrar estados técnicos ', [
                        'value'=>Url::to('index.php?r=estado/create'),
