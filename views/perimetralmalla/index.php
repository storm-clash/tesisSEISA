...
/* @var $searchModel app\models\PerimetralmallaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = 'Malla Perimetral';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="perimetralmalla-index">
    <div class="card">
        <div class="card-header card-header-warning">
            <h4 class="card-title"><?=$this->title?></h4>
            <p class="card-category">Registro de Parámetro de Clasificación: Perimetral de la Malla de Tierra</p>
        </div>
    ...
    <p>
        <?= Html::button('Registrar Perimetral de la Malla de Tierra', [
            'value'=>Url::to('index.php?r=perimetralmalla/create'),
    ...
    Modal::begin(
        [
            'title'=>'<h4>Perimetral de la Malla de Tierra</h4>',
            'id'=>'your-modal',
            'size'=>'modal-md',
