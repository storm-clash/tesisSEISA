...
/* @var $searchModel app\models\FormaspagoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = 'Formaspagos';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="formaspago-index">
    <div class="card">
        <div class="card-header card-header-warning">
            <h4 class="card-title"><?=$this->title?></h4>
            <p class="card-category">Registro de Métodos de Pago</p>
        </div>
    ...
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
                ...
                <p>
                    <?= Html::button('Registrar Métodos de Pago', [
                        'value'=>Url::to('index.php?r=formaspago/create'),
