...
/**
 * This is the model class for table "nivelessepresores".
 *
 * @property int $id
 ...
 */
class Nivelessepresores extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Sistemasproteccionrayos::className(), ['nivelesSepresores_id' => 'id']);
    }
    public static function combo(){
        $models = Nivelessepresores::find()->all();
