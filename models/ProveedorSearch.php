...
class ProveedorSearch extends Proveedor
{
    ...
    {
        return [
            [['idproveedor', 'telefono', 'cuentaBancaria'], 'integer'],
            [['nombreProveedor', 'nombreRepresentante', 'correo', 'direccion'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'nombreProveedor', $this->nombreProveedor])
            ->andFilterWhere(['like', 'nombreRepresentante', $this->nombreRepresentante])
